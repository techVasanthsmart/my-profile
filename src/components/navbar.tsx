          ...
          {navLinks.map((link) =>
            link.label === "Projects" ? (
              <li key={link.href} className="group relative">
                <Link
                  href={link.href}
                  className="nav-link relative flex items-center gap-1 text-sm font-medium text-slate-600 transition-colors duration-300 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-neon-cyan py-2"
                >
                  {link.label}
              ...
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="nav-link relative text-sm font-medium text-slate-600 transition-colors duration-300 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-neon-cyan group py-2"
                >
                  {link.label}
                  <span className="absolute -bottom-1 left-0 h-0.5 w-0 bg-indigo-600 transition-all duration-300 group-hover:w-full group-hover:shadow-[0_0_10px_rgba(99,102,241,0.5)] dark:bg-neon-cyan dark:group-hover:shadow-[0_0_10px_rgba(0,243,255,0.5)]"></span>
                </Link>
